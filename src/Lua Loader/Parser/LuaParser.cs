...
public partial class LuaParser : Parser {
	...
	public partial class StatLocalAssignmentContext : StatContext {
		...
		public StatLocalAssignmentContext(StatContext context) { CopyFrom(context); }
		public override TResult Accept<TResult>(IParseTreeVisitor<TResult> visitor) {
			ILuaVisitor<TResult> typedVisitor = visitor as ILuaVisitor<TResult>;
			if (typedVisitor != null) return typedVisitor.VisitStatLocalAssignment(this);
			else return visitor.VisitChildren(this);
		}
	}
	...
	public partial class StatForContext : StatContext {
		public ITerminalNode NAME() { return GetToken(LuaParser.NAME, 0); }
		public ExpContext[] exp() {
			return GetRuleContexts<ExpContext>();
		}
		...
		public StatForContext(StatContext context) { CopyFrom(context); }
		public override TResult Accept<TResult>(IParseTreeVisitor<TResult> visitor) {
			ILuaVisitor<TResult> typedVisitor = visitor as ILuaVisitor<TResult>;
	...
	public partial class StatAssignmentContext : StatContext {
		...
		public StatAssignmentContext(StatContext context) { CopyFrom(context); }
		public override TResult Accept<TResult>(IParseTreeVisitor<TResult> visitor) {
			ILuaVisitor<TResult> typedVisitor = visitor as ILuaVisitor<TResult>;
			if (typedVisitor != null) return typedVisitor.VisitStatAssignment(this);
			else return visitor.VisitChildren(this);
		}
	}
	...
	public partial class StatFunctionContext : StatContext {
		public FuncnameContext functionName;
		public FuncbodyContext functionBody;
	...
	public partial class StatSemicolonContext : StatContext {
		public StatSemicolonContext(StatContext context) { CopyFrom(context); }
		public override TResult Accept<TResult>(IParseTreeVisitor<TResult> visitor) {
			ILuaVisitor<TResult> typedVisitor = visitor as ILuaVisitor<TResult>;
			if (typedVisitor != null) return typedVisitor.VisitStatSemicolon(this);
			else return visitor.VisitChildren(this);
		}
	}
	...
	public partial class StatForEachContext : StatContext {
		public NamelistContext namelist() {
			return GetRuleContext<NamelistContext>(0);
		}
		public ExplistContext explist() {
		...
		public StatForEachContext(StatContext context) { CopyFrom(context); }
		public override TResult Accept<TResult>(IParseTreeVisitor<TResult> visitor) {
			ILuaVisitor<TResult> typedVisitor = visitor as ILuaVisitor<TResult>;
			if (typedVisitor != null) return typedVisitor.VisitStatForEach(this);
			else return visitor.VisitChildren(this);
		}
	}
	...
	public StatContext stat() {
		...
		try {
			...
			case 13:
				...
				State = 150; ((StatFunctionContext)_localctx).functionName = funcname();
				State = 151; ((StatFunctionContext)_localctx).functionBody = funcbody();
				}
				break;
			case 14:
				...
				break;
			case 15:
				_localctx = new StatLocalAssignmentContext(_localctx);
	...
	public partial class FuncbodyContext : ParserRuleContext {
		public ParlistContext parameterList;
		public BlockContext block() {
			return GetRuleContext<BlockContext>(0);
		}
	...
	public FuncbodyContext funcbody() {
		...
		try {
			...
			if (_la==T__25 || _la==NAME) {
				{
				State = 331; _localctx.parameterList = parlist();
				}
			}
	...
	public partial class ParlistContext : ParserRuleContext {
		public NamelistContext parameterNames;
		public NamelistContext namelist() {
			return GetRuleContext<NamelistContext>(0);
		}
	...
	public ParlistContext parlist() {
		...
		try {
			...
			case NAME:
				EnterOuterAlt(_localctx, 1);
				{
				State = 338; _localctx.parameterNames = namelist();
				State = 341;
				ErrorHandler.Sync(this);
				_la = TokenStream.LA(1);
				if (_la==T__14) {
